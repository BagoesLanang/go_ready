    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Saran & Kesan TPM', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: const [
                      Text('Detailed Report', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                      Text('Required', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                    ],
                  ),
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: const Text('Yeay! Saran & Kesan berhasil dikirim 🚀', style: TextStyle(color: Colors.white)),
                            backgroundColor: AppColors.successGreen,
                            behavior: SnackBarBehavior.floating,
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                          ),
                        );
                        Navigator.pop(context); // Balik ke halaman More
                      },
                  ...
                  const Center(
                    child: Text('Information submitted is securely logged for review.', style: TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                  ),
                ],
              ),
            ),
